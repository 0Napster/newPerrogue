...
var _fs = require('fs');var _fs2 = _interopRequireDefault(_fs);var _path = require('path');var _path2 = _interopRequireDefault(_path);var _gulp = require('gulp');var _gulp2 = _interopRequireDefault(_gulp);var _del = require('del');var _del2 = _interopRequireDefault(_del);var _runSequence = require('run-sequence');var _runSequence2 = _interopRequireDefault(_runSequence);var _browserSync = require('browser-sync');var _browserSync2 = _interopRequireDefault(_browserSync);var _swPrecache = require('sw-precache');var _swPrecache2 = _interopRequireDefault(_swPrecache);var _gulpLoadPlugins = require('gulp-load-plugins');var _gulpLoadPlugins2 = _interopRequireDefault(_gulpLoadPlugins);var _psi = require('psi');var _package = require('./package.json');var _package2 = _interopRequireDefault(_package);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
// Lint JavaScript
_gulp2.default.task('lint', function () {return (
        _gulp2.default.src('app/scripts/**/*.js').
        pipe($.eslint()).
        pipe($.eslint.format()).
        pipe($.if(!_browserSync2.default.active, $.eslint.failOnError())));});
...
_gulp2.default.task('clean', function (cb) {return (0, _del2.default)(['.tmp', 'dist/*', '!dist/.git'], { dot: true });});
...
_gulp2.default.task('serve', ['scripts', 'styles'], function () {
    ...
    _gulp2.default.watch(['app/scripts/**/*.js'], ['lint', 'scripts']);
    _gulp2.default.watch(['app/images/**/*'], reload);});


// Build and serve the output from the dist build
_gulp2.default.task('serve:dist', ['default'], function () {return (
        (0, _browserSync2.default)({ 
            notify: true, 
            logPrefix: 'WSK', 
            // Allow scroll syncing across breakpoints
...
_gulp2.default.task('pagespeed', function (cb) {return (
...
_gulp2.default.task('copy-sw-scripts', function () {
    return _gulp2.default.src(['node_modules/sw-toolbox/sw-toolbox.js', 'app/scripts/sw/runtime-caching.js']).
